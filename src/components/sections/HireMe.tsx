...
import { ArrowRight, ShieldCheck, Timer, Workflow, Mail, Linkedin, Github } from 'lucide-react';
import Link from 'next/link';
import { WhatsappIcon } from '../icons/WhatsappIcon';

type AnvilImpactProps = {
  className?: string;
};

const AnvilImpact = ({ className }: AnvilImpactProps) => (
...
const highlights = [
  { title: 'High-Impact Builds', description: 'Performance-first web apps with crisp UX and clean systems.', icon: AnvilImpact },
